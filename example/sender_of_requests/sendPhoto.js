...
var SendPhoto = /** @class */ (function (_super) {
    __extends(SendPhoto, _super);
    function SendPhoto() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    // Send an image (Telegram) and return <response>
    SendPhoto.telegram = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterTelegram.sendPhoto({
    ...
    SendPhoto.vk = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterVK.sendPhoto({
    ...
    SendPhoto.viber = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterViber.sendPhoto({
