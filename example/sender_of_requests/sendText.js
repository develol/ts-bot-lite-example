...
var SendText = /** @class */ (function (_super) {
    __extends(SendText, _super);
    function SendText() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    // Send a text message (Telegram) and return <response>
    SendText.telegram = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterTelegram.sendText({
    ...
    SendText.vk = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterVK.sendText({
    ...
    SendText.viber = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterViber.sendText({
