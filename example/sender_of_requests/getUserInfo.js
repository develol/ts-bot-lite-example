...
var GetUserInfo = /** @class */ (function (_super) {
    __extends(GetUserInfo, _super);
    function GetUserInfo() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    // Get user information (Telegram) and return <response>
    GetUserInfo.telegram = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterTelegram.getUserInfo({
    ...
    GetUserInfo.vk = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterVK.getUserInfo({
    ...
    GetUserInfo.viber = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requesterViber.getUserInfo({
